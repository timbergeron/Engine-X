...
typedef struct
{
	...
	qbool					paused;
	int						current_skill_at_map_start;		// Moved from global
	...
	int						entities_string_count;			// Counts the entities in the entity string
	int						num_edicts;
	int						max_edicts;
...
typedef struct client_s
{
	...
	qbool					privileged;						// can execute any host command
