...
*/
#include "quakedef.h"
#include "sound.h"		// Baker: must be before nehahra.h
#include "nehahra.h"	// Baker: Needed
#include "winquake.h"
...
//			Con_SafePrintf ("Using secondary sound buffer\n");
	...
	else
	{
		...
		pDSBuf = pDSPBuf;
//joe		Con_SafePrintf ("Using primary sound buffer\n");
	}
...
void SNDDMA_Submit (void)
{
	...
	while (1)
	{
		...
		{
			Con_DevPrintf (DEV_SOUND, "Sound overrun\n");
			break;
		}
