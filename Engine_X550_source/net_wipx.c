...
extern qbool winsock_initialized;
...
//=============================================================================
extern qbool	winsock_lib_initialized;
...
// make sure LoadLibrary has happened successfully
	...
	if (pgethostname(buff, MAXHOSTNAMELEN) == 0)
	{
		...
		if (COM_StringMatch (sv_hostname.string, "UNNAMED"))
		{
			...
			Cvar_SetStringByRef (&sv_hostname, buff);
		}
	}
